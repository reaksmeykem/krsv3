        ...
        <section class="md:grid md:grid-cols-3 lg:gap-6 px-6 lg:px-0">
            <div class="col-span-2">
                ...
                <ul class="flex items-center justify-center md:justify-start space-x-6 mt-6">
                    <li><a aria-label="Connect with kemreaksmey on facebook page" target="_blank" href="https://web.facebook.com/kemreaksmeyreal"><i class="fa-brands fa-facebook text-3xl text-slate-700 hover:text-[#F4CE14]"></i></a></li>
                    <li><a aria-label="Connect with kemreaksmey on youtube" target="_blank" href="https://www.youtube.com/@reaksmeykemofficail"><i class="fa-brands fa-youtube text-3xl text-slate-700 hover:text-[#F4CE14]"></i></a></li>
                    <li><a target="_blank" aria-label="Connect with kemreaksmey on github" href="https://github.com/reaksmeykem"><i class="fa-brands fa-github text-3xl text-slate-700 hover:text-[#F4CE14]"></i></a></li>
                </ul>
            </div>
