            ...
            <div class="text-center mt-[60px]">
                @if($latestArticles->hasMorePages())
                    <span role="status" wire:loading wire:target="loadMore" class="ml-2">
                        <svg aria-hidden="true" class="inline w-7 h-7 text-gray-200 animate-spin dark:text-gray-600 fill-[#F4CE14]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
