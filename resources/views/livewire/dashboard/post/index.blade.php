<div>
    ...
    <div class="bg-white p-8 rounded-xl">
        ...
        @if($editing)
            @include('dashboard.post.edit-form')
        @else
                ...
                <tbody>
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4 text-right flex space-x-2">
                            <a href="{{ route('post.edit', $post->id) }}" class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-1 px-3 border border-blue-500 hover:border-transparent rounded"><i class="fa-solid fa-pen-to-square"></i></a>
